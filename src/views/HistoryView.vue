<template>
  <section class="animate-fadeIn flex flex-col p-10 rounded-lg bg-purple-800">
    <h1 class="mb-6 text-3xl text-center text-purple-50 font-semibold">
      {{ currentCrypto.name }} History
    </h1>
    <CryptoHistory v-if="history.price" />
    <CryptoForm v-else />
  </section>
</template>
